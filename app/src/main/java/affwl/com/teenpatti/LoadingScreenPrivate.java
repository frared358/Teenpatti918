    ...
    private class GameRequestAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (msg.equalsIgnoreCase("Cards generated sucessfully") || msg.equalsIgnoreCase("Game request successfully registered. Wait for second user")|| msg.equalsIgnoreCase("Game request already registered")||msg.equalsIgnoreCase("Game Started")) {
